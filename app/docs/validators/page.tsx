...
export default function ValidatorsIndexPage() {
  const section = getSectionBySlug("validators");
        ...
        <div className="flex gap-12">
          ...
          <div className="flex-1 min-w-0 max-w-3xl">
            ...
            >
              ...
              <div className="not-prose mb-8 p-6 rounded-xl bg-yellow-500/5 border border-yellow-500/20">
                <h3 className="text-lg font-semibold text-yellow-400 mb-2">Private Testnet</h3>
                <p className="text-sm text-muted-foreground">
                  Validator participation is currently limited to the private testnet. 
                  Public validator onboarding will be announced when available.
                </p>
              </div>
